...
The user guide explains all the configuration options available in EdgeTX as well as some high-level theoretical information about EdgeTX usage and model controls. It is broken into sections - one section covering the interface for [Color Screen Radios](https://edgetx.gitbook.io/edgetx-user-manual/edgetx-user-manual/user-manual-for-color-screen-radios) and one section covering the interface for [Black and White screen radios](https://edgetx.gitbook.io/edgetx-user-manual/b-and-w-radios).
...
See the [Contributors ](https://edgetx.gitbook.io/edgetx-user-manual/more/contributors)section for a list of direct and indirect contributors.
