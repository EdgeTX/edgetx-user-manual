...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2n2y0XsJcrhXt3asceP0/bw-radios/model-select/heli-setup
---
...
* **Swash Type** - Swash type for your model. Options are **---** (disables Heli/CCPM mixing), **120, 120x, 140, and 90.**
