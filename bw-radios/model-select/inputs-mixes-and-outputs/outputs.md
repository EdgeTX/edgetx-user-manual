...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2n2y0XsJcrhXt3asceP0/bw-radios/model-select/inputs-mixes-and-outputs/outputs
---
...
* **Subtrim** - The subtrim value (max 100). It can also be set to a global variable by long-pressing the **\[Enter]** button to switch to GV Mode and then selecting the desire global variable.
