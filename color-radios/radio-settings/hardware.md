...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2n2y0XsJcrhXt3asceP0/color-radios/radio-settings/hardware
---
...
**Customizable Switches** (select radios) - Shows the physical and logical state of the customizable switches, as well as the LED state or color (if the handset supports RGB customizable switches). Only shown on radios with customizable switch hardware.
