...
* **Internal GPS** (select radios) - Shown on radios with a built-in GPS chip when a serial port is set to the **GPS** mode. Displays GPS fix status, satellite count, and HDOP.
