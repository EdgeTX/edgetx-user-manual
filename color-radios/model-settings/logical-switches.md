...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2n2y0XsJcrhXt3asceP0/color-radios/model-settings/logical-switches
---
...
<figure><img src="../../.gitbook/assets/colorlcd_model_ls.png" alt=""><figcaption><p>Logical Switches screen</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/colorlcd_model_ls_edit.png" alt=""><figcaption><p>Logical Switches configuration screen</p></figcaption></figure>

After selecting to edit a logical switch, you will have the following configuration options:

* **Func** - The logical function that you want to use. See [Logical Switch Functions](logical-switches.md#logical_switches_judgment_conditions_and_logical_expressions) below for a description of the possible functions you can use.
