...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/2n2y0XsJcrhXt3asceP0/color-radios/reset-telemetry
---
...
**Reset timer 1 / 2 / 3** - Resets only the selected timer to zero regardless of the configured persistence setting.
