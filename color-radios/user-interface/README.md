...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/2n2y0XsJcrhXt3asceP0/color-radios/user-interface
---
...
*   **\[SYS]** - System Button\
    ...
    \- Long press the **\[SYS]** button to go to the [Radio Setup](../radio-settings/radio-settings/) page.
* **\[MDL]** - Model Button\
